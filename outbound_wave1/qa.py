...
_TESTING_FRICTIONS = frozenset({
    ...
    FRICTION_INTERVIEW_WEAK_SIGNAL, FRICTION_PIECES_NOT_JOINED,
    FRICTION_NO_TRACK_RECORD_YET,
    FRICTION_MORE_CVS, FRICTION_OPS_PROCESS_MIX,
    FRICTION_PIECES_VS_COMBINATION,
})
...
COHERENT_FRICTIONS = {
    ...
    (PROOF_REMOTE_READINESS, OFFER_REMOTE_READINESS_OVERVIEW): frozenset({
        ...
        FRICTION_MULTI_AREA_SHORTLIST, FRICTION_COMBINED_SCOPE_POOL,
        FRICTION_MORE_CVS, FRICTION_REMOTE_FIT,
    }),
    ...
    (PROOF_HEADCOUNT_MODEL, OFFER_HEADCOUNT_OVERVIEW): frozenset({
        ...
        FRICTION_HEADCOUNT_IS_A_FACTOR, FRICTION_OUTSIDE_VENDOR,
    }),
