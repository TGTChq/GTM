...
class JobSourceResolutionCostTests(unittest.TestCase):
    ...
    def test_direct_official_link_skips_careers_discovery(self, discover, fetch):
        fetch.return_value = {
            "status_code": 200,
            "final_url": "https://example.com/careers/jobs/123",
            "text": "<html><body><h1>Data Analyst</h1><p>Responsibilities and qualifications. " + "x" * 600 + "</p></body></html>",
        }
