...
def test_reviewing_every_net_new_posting_is_a_100_percent_review_rate(tmp_path):
    ...
    # 100% here means every captured posting entered review, which is what a run
    # that completed its slices produces. It is not automatic -- an interrupted run
    # reviews fewer than it captured; see tests/test_captured_equals_reviewed.py.
